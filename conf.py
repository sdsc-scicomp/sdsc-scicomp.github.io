...
BLOG_AUTHOR = "Andrea Zonca"  # (translatable)
BLOG_TITLE = "SDSC Scientific Computing Applications"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://scicomp.sdsc.edu/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://scicomp.sdsc.edu/"
BLOG_EMAIL = "zonca@sdsc.edu"
BLOG_DESCRIPTION = "SDSC Scientific Computing Applications group"  # (translatable)
